...
strikegroup =
{
	...
	{		
		-- Surround BCs
		{
			...
			OffsetFromParent = {0,1.65001,-0.2},
			CanGrow = 0,
		},
		{
			FamilyChild = "BigCapitalShip, SmallCapitalShip",
			NoTypeChild = "Vgr_Battlecruiser",	-- Vgr BC's shoot missiles up, so use a alt layout...
			FamilyOccupy = "BigCapitalShip, SmallCapitalShip",
			OffsetFromParent = {0,-1.65002,-0.2},
			CanGrow = 0,
		},
		{
			FamilyChild = "BigCapitalShip, SmallCapitalShip",
		...
		-- Forward Positions
		{
			...
			OffsetFromParent = {-0.5,-0.5,1.75001},
			Proxies = { "WallFrDR", "WallFrDRO" },
			CanGrow = 0,
		},
		{
			NoFamilyOccupy = "BigCapitalShip, SmallCapitalShip",
			OffsetFromParent = {0.5,-0.5,1.75002},
			Proxies = { "WallFrDL", "WallFrDLO" },
			CanGrow = 0,
		},
		{
			NoFamilyOccupy = "BigCapitalShip, SmallCapitalShip",
			OffsetFromParent = {-0.5,0.5,1.75003},
			Proxies = { "WallFrUR", "WallFrURO" },
			CanGrow = 0,
		},
		{
			NoFamilyOccupy = "BigCapitalShip, SmallCapitalShip",
			OffsetFromParent = {0.5,0.5,1.75004},
		...
		-- Container for named nodes
		{
			...
			Children =
			{
				-- Base Frigates
				{
					...
					OffsetFromParent 		= {-0.525,-1.2,-0.25},
					ElseChild = "WallDR",
				},
				{	-- Anythings Spawn behind of Frigate (when root)
					Name = "WallFrDRO",
					FamilyChild = "Frigate",
					NoFamilyOccupy = "Frigate",
					OffsetFromParent 		= {-1.1,0,-0.85},
