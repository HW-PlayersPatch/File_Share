...
fx = {
	...
	property_16 = {name = "Particle_Scale", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3.5, 1, 3.5},},
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.13875, 0, 0.21875, 57.6, 0.36, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "DEBRIS_PANEL_SQUARE02"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 10},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.1125, 6.93333, 0.475, 0, 1, 0},},
