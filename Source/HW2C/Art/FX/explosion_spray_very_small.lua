...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "CLOUD_RING_combo_small"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5, 0.17125, 0, 1, 0},},
