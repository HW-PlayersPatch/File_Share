...
fx = {
	...
	property_02 = {name = "FX3", type = "VARTYPE_STRING", value = "resourcing_dust_black_spray_LOD"},
	...
	property_00 = {name = "Fx1", type = "VARTYPE_STRING", value = "RESOURCING_DUST_SPRAY_LOD"},},}
