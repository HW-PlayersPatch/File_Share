...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/CLOUDS/MASSIVE_FIRE_SPHERE_RING.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 3},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.025, 0, 0.06, 6.66667, 0.11578, 11.2, 0.19141, 13.83529, 0.32031, 16.14118, 1, 28.6359},},
