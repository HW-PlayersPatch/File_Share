...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 72, 0.09125, 19.46667, 0.20625, 0, 1, 0},},
	property_05 = {name = "Emitter_Drag", type = "VARTYPE_FLOAT", value = 0.75},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "DMG_FIRE_TRAIL_FIGHTER"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 18.8, 0.3425, 1.06667, 1, 0},},
