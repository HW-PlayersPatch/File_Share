...
fx = {
	...
	property_16 = {name = "Particle_Scale", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3, 1, 3},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "SURFACEXPLODE_FIRE_CELL_RING"},
