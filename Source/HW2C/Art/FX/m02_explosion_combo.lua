...
fx = {
	...
	property_04 = {name = "FX5", type = "VARTYPE_STRING", value = "dmg_cloud_flash_ring_white_large"},
	property_03 = {name = "FX4", type = "VARTYPE_STRING", value = ""},
	property_00 = {name = "Fx1", type = "VARTYPE_STRING", value = "DMG_CLOUD_FLASH_RING_large"},},}
