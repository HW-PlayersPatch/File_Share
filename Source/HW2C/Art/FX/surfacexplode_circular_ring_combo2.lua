...
fx = {
	...
	property_07 = {name = "FX8", type = "VARTYPE_STRING", value = "SURFACEXPLODE_SURFACE_LARGE_WAVE_RING"},
	property_02 = {name = "FX3", type = "VARTYPE_STRING", value = ""},
	property_01 = {name = "Fx2", type = "VARTYPE_STRING", value = "SURFACEXPLOSION_CICULAR_RING2_SOLO"},
