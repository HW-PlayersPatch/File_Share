...
fx = {
	...
	property_25 = {name = "SortOrder", type = "VARTYPE_INT", value = 5},
	property_24 = {name = "RandomBitmap", type = "VARTYPE_BOOL", value = 1},
	property_23 = {name = "BirthSpawn_Fx", type = "VARTYPE_STRING", value = "FLASH_FLASH_GLOW"},
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/FIRERY EXPLOSIONS/RING_PARTICLES.TGA"},
