...
PatchInfoDialog = {size = {0, 0, 800, 600}, stylesheet = "HW2StyleSheet", pixelUVCoords = 1, RootElementSettings = {backgroundColor = "FEColorBackground2"}, ;
	...
	{type = "TextLabel", name = "lblTitle", position = {4, 0}, size = {(DIALOGWIDTH - 10), 15}, Text = {textStyle = "FEHeading3", vAlign = "Middle", text = "$2562"},},
	{type = "TextLabel", position = {4, 15}, size = {(DIALOGWIDTH - 10), 13}, Text = {textStyle = "FEHeading4", text = "$2563"},},},
	...
	{type = "TextButton", position = {(((DIALOGWIDTH - 6) / 2) - 61), 2}, name = "btnOk", buttonStyle = "FEButtonStyle2", Text = {textStyle = "FEButtonTextStyle", text = "$3614"}, onMouseClicked = "UI_HideScreen('PatchInfoDialog')"},},},},},}
