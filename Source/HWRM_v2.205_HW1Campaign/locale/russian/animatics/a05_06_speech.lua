...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_05_06" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A05_06.dat" );
...
AddSubtitleEvent( 7.0, Actor_LocationCard, "$65525", 0 );

AddSubtitleEvent( 12.4, Actor_LocationCard, "$65526", 0 );

AddSubtitleEvent( 31.8, Actor_LocationCard, "$65527", 0 );
