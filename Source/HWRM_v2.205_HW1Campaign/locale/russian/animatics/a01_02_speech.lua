...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_01_02" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A01_02.dat" );
...
AddSubtitleEvent( 0.8, Actor_LocationCard, "$65395", 0 );

AddSubtitleEvent( 6.0, Actor_LocationCard, "$65396", 0 );

AddSubtitleEvent( 12.0, Actor_LocationCard, "$65397", 0 );

AddSubtitleEvent( 18.0, Actor_LocationCard, "$65398", 0 );

AddSubtitleEvent( 25.0, Actor_LocationCard, "$65399", 0 );

AddSubtitleEvent( 31.0, Actor_LocationCard, "$65400", 0 );
