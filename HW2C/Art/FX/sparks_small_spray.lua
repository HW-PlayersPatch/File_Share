...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "SPARKLE_RING_SMALL"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3.73333, 1, 0},},
