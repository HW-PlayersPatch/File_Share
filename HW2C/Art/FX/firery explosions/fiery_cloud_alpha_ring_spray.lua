...
style = "STYLE_SPRAY",properties = {
	property_15 = {name = "Gravwell_Strength", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 16, 0.09875, 15.2, 0.1225, 0, 1, 0},},
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 71.2, 0.01375, 71.2, 0.0325, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "FIERY_CLOUD_ALPHA_RING"},
