...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 4.5, 0.1375, 4.43333, 0.19375, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "FIERY_STREAMER_BEAM"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0.63333, 1, 0},},
