...
fx = {
	...
	property_09 = {name = "Emitter_Volume", type = "VARTYPE_ARRAY_TIMEVECTOR3", value = {entry_00 = {0, 0, 0, 0}, entry_01 = {1, 2, 2, 2},},},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "cloud_ring_combo_smal_flakl"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 8.6, 0.17125, 0, 1, 0},},
	...
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0.275, 0.2775, 0, 1, 0},},
