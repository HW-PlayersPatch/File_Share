...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "EXPLOSION_wave_RING"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.1975, 0.33333, 0.29625, 91.73333, 0.405, 0.33333, 0.565, 0, 1, 0},},
