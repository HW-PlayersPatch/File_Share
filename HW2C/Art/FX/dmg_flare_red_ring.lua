...
fx = {
	...
	property_21 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/BULLET_SPLASH/FLARE_RED.TGA"},
	...
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5, 1, 0},},
