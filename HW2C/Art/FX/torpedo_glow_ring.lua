...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/MUZZLE_FLASHES/BIG_FLASH_GREEN.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 0.5},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3.73333, 0.225, 3.2, 1, 0},},
