...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 2.13333, 1, 2.66667},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "CHARGED_PARTICLE"},
