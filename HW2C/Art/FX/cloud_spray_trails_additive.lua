...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "CLOUD_RING_ADITTIVE"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 9.06667, 1, 9},},
	...
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 3.8, 1, 2.13333},},
	property_00 = {name = "Emitter_Duration", type = "VARTYPE_FLOAT", value = 0.5},
