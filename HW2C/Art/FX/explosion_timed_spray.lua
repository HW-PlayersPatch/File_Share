...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "EXPLOSION_FINGERS"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 13.53333, 0.18125, 0.06667, 0.8625, 0.53333, 0.8875, 21.6, 1, 0},},
