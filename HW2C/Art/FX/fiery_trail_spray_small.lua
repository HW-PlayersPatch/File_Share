...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 100, 1, 100},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "FIERY_FLASH_RING_SMALL"},
