...
fx = {
	...
	property_16 = {name = "Particle_Scale", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0.75, 1, 0.7},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "dmg_flare_red_ring_pkm"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 0},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 50, 1, 50},},
