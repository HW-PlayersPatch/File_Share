...
fx = {
	...
	property_24 = {name = "BirthSpawn_Fx", type = "VARTYPE_STRING", value = "dmg_cloud_flash_ring_white_small"},
	...
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 11.73333, 0.24, 14.43509, 1, 16.96141},},
