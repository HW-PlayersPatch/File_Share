...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 45.86666, 0.02375, 0, 1, 0},},
	property_05 = {name = "Emitter_Drag", type = "VARTYPE_FLOAT", value = 0.8},
	property_08 = {name = "Emitter_Deviation", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 41.6, 1, 180},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "DMG_HULL_PANEL06_bentusi"},
	property_14 = {name = "Particle_Dynamics", type = "VARTYPE_INT", value = 6},
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 8, 0.0825, 0, 1, 0},},
