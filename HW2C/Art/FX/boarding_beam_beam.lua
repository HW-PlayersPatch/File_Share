...
fx = {
	...
	property_03 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/BOARDING_BEAM/BOARDING_BEAM_GLOW.TGA"},
	property_06 = {name = "Length", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 80, 1, 80},},
