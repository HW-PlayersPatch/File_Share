...
fx = {
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "ion_explosion_ring_small"},
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 5.33333, 0.22, 0, 1, 0},},
