...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.03, 11.06666, 0.095, 0, 1, 0},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "plasma_ball_ring"},
