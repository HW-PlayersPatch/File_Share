...
fx = {
	...
	property_20 = {name = "Texture", type = "VARTYPE_STRING", value = "DATA:ART/FX/BULLET_SPLASH/FLARE_BLUE.TGA"},
	property_12 = {name = "Duration", type = "VARTYPE_FLOAT", value = 3},
	property_00 = {name = "Radius", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 9.06667, 0.185, 3.2, 1, 0},},
