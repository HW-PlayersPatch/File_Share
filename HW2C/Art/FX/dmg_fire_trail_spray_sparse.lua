...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.0825, 0, 0.09375, 17.33333, 0.1625, 0, 1, 0},},
	...
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 99.2, 0.255, 25.6, 1, 0},},
