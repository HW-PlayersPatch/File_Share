...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 46.4, 0.025, 0, 1, 0},},
	property_05 = {name = "Emitter_Drag", type = "VARTYPE_FLOAT", value = 0.8},
	property_08 = {name = "Emitter_Deviation", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 21.33333, 1, 180},},
	...
	property_13 = {name = "Particle_Fx", type = "VARTYPE_STRING", value = "DMG_HULL_PANEL03_bentusi"},
