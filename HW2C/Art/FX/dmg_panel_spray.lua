...
fx = {
	...
	property_06 = {name = "Emitter_Rate", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 64.8, 0.29625, 0, 1, 0},},
	...
	property_11 = {name = "Particle_Speed", type = "VARTYPE_ARRAY_TIMEFLOAT", value = {0, 0, 0.04625, 23.46667, 0.2375, 33.6, 1, 0},},
