...
-- Military
	...
	cfg_hyperspace_effect_time = 0.1,
...
String_Properties = {
	...
	path_ai = [[data:scripts/races/observer/scripts/def_ai.lua]],
	
	path_ai_special = [[data:scripts/races/observer/scripts/ai_special.lua]],
	path_ai_research = [[data:scripts/races/observer/scripts/ai_upgrades.lua]],
	path_ai_build = [[data:scripts/races/observer/scripts/ai_build.lua]],
	
	path_crate_locate = [[data:scripts/races/observer/scripts/crate_locate.lua]],
	path_crate_ships = [[data:scripts/races/observer/scripts/crate_ships.lua]],
	
	def_type_mothership = "obs_observer",
	def_type_carrier = "obs_observer",
	def_type_scout = "obs_observer",
}
