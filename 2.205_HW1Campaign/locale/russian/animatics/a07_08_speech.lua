...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_07_08" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A07_08.dat" );
...
AddSubtitleEvent( 0.5, Actor_LocationCard, "$65560", 0 );

AddSubtitleEvent( 5.0, Actor_LocationCard, "$65561", 0 );

AddSubtitleEvent( 10.0, Actor_LocationCard, "$65562", 0 );

AddSubtitleEvent( 16.0, Actor_LocationCard, "$65563", 0 );

AddSubtitleEvent( 22.0, Actor_LocationCard, "$65564", 0 );
