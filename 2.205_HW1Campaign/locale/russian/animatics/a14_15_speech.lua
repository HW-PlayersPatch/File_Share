...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_14_15" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A14_15.dat" );
...
AddSubtitleEvent( 3.5, Actor_LocationCard, "$65696", 0 );

AddSubtitleEvent( 10.0, Actor_LocationCard, "$65697", 0 );

AddSubtitleEvent( 14.0, Actor_LocationCard, "$65698", 0 );

AddSubtitleEvent( 18.0, Actor_LocationCard, "$65699", 0 );

AddSubtitleEvent( 20.0, Actor_LocationCard, "$65700", 0 );