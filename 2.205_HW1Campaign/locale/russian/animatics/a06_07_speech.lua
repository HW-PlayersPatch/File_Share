...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_06_07" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A06_07.dat" );
...
AddSubtitleEvent( 5.0, Actor_LocationCard, "$65539", 0 );
