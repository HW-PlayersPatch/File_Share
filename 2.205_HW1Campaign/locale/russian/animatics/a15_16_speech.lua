...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_15_16" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A15_16.dat" );
...
AddSubtitleEvent( 1.0, Actor_LocationCard, "$65716", 0 );

AddSubtitleEvent( 3.0, Actor_LocationCard, "$65717", 0 );
