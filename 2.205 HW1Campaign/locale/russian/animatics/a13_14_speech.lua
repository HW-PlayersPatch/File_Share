...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_13_14" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A13_14.dat" );
...
AddSubtitleEvent( 1.5, Actor_LocationCard, "$65685", 0 );

AddSubtitleEvent( 9.5, Actor_LocationCard, "$65686", 0 );

AddSubtitleEvent( 14.0, Actor_LocationCard, "$65687", 0 );

AddSubtitleEvent( 18.0, Actor_LocationCard, "$65688", 0 );
