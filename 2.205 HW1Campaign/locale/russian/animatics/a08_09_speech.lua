...
SetSpeechFolder( "Data:Sound/Speech/Animatic/ANI_08_09" );

-- specify the .dat file to use for localized text
AddLocalizedText( "locale:leveldata/campaign/homeworldclassic/A08_09.dat" );
...
AddSubtitleEvent( 0.5, Actor_LocationCard, "$65580", 0 );

AddSubtitleEvent( 8.0, Actor_LocationCard, "$65581", 0 );

AddSubtitleEvent( 16.0, Actor_LocationCard, "$65582", 0 );

AddSubtitleEvent( 24.0, Actor_LocationCard, "$65583", 0 );

AddSubtitleEvent( 32.0, Actor_LocationCard, "$65584", 0 );

AddSubtitleEvent( 47.0, Actor_LocationCard, "$65585", 0 );

AddSubtitleEvent( 52.0, Actor_LocationCard, "$65586", 0 );
