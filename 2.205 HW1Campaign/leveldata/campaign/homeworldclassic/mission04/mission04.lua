...
function Init_Mission04_Traders_TimeToTrade(TeamName)
	...
	if (Player_GetRU(0) < 500) then     --kasfRUsGet(0)
	
	KAS_SetTradeCost("IonCannons", 300)    --kasfSetBaseTechnologyCost("IonWeapons", 300)
	elseif (Player_GetRU(0) > 500) then     --kasfRUsGet(0)
	
	KAS_SetTradeCost("IonCannons", 500)    --kasfSetBaseTechnologyCost("IonWeapons", 500)
	end 
	...
	KAS_SetTradeCost("PlasmaBombLauncher", 300)    --kasfSetBaseTechnologyCost("PlasmaWeapons", 300)
	elseif (Player_GetRU(0) > 500) then     --kasfRUsGet(0)
	
	KAS_SetTradeCost("PlasmaBombLauncher", 500)    --kasfSetBaseTechnologyCost("PlasmaWeapons", 500)
	end 
...
function Watch_Mission04_P1Mothership(TeamName)
	...
	if (_VIFONCE027[TeamName] == 0 and (SobGroup_Count("P1Mothership") < 1)) then  -- "ifonce" #27    --kasfShipsCount(kasAITeamShipsPtr("P1Mothership"))
