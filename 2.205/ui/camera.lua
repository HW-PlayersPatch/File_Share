...
verticalFOV = 70 --
cameraDefaultMaxDistance = 6000			-- How far the camera can zoom out
cameraDistanceMax = 6000                   -- max distance possible in the in game options screen
...
cameraTwkPanSpeedFactor				= 1.0					-- the factor (multiplied by camera distance) that defines the pan speed
