...
Data = 
{
	...
	maxBreakDistanceAg = {1700.0,1700,1},
	maxBreakDistanceEv = {1800.0,1800,1},

	-- break off the attack run when this distance from the target
	distanceFromTargetToBreak = 450.0,
	distanceFromTargetToBreakAg = {500.0,600,1},
	distanceFromTargetToBreakEv = {1100.0,600,1},
	...
	-- how to orient the choice of break point, options are Attacker,Target and TargetPoint
